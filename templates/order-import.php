...
if ( isset($_GET['ref']) ) {
    ...
    $return = admin_url( 'admin.php?page=followup-emails-settings' );
}
?>
<script>
...
<div class="wrap">
    <h2>
        <?php _e('Order Importer', 'follow_up_emails'); ?>
    </h2>

    <p id="total-orders-label"><?php _e('Loading', 'follow_up_emails'); ?>...</p>

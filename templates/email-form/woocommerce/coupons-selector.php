<div class="options_group storewide non-signup hideable <?php do_action('fue_form_coupons_class', $email); ?> coupons_div">
    ...
    <p class="form-field">
        ...
        <input
            ...
            data-multiple="false"
            data-placeholder="<?php _e('Search for a coupon&hellip;', 'woocommerce'); ?>"
            value="<?php echo $coupon_id; ?>"
            data-selected="<?php echo esc_attr( $coupon_name ); ?>"
            >
        <!--<select id="coupon_id" name="meta[coupon]" class="wc-coupon-search" data-placeholder="<?php _e('All coupons', 'follow_up_emails'); ?>" data-multiple="false" style="width:400px;">
            <option value=""></option>
            <?php

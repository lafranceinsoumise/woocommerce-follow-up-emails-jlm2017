...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
    <thead>
    <tr>
        <th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Customer', 'follow_up_emails'); ?></th>
        <th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Email Address', 'follow_up_emails'); ?></th>
        ...
        <th scope="col" style="text-align:left; border: 1px solid #eee;"><?php _e('Date', 'follow_up_emails'); ?></th>
    </tr>
    </thead>
    <tbody>
    <?php

...
class FUE_Addon_Twitter_Admin {
    ...
    public function reset_data() {
        ...
        wp_redirect( 'admin.php?page=followup-emails-settings&tab=integration&message='. urlencode(__('Twitter data removed', 'follow_up_emails')) );
        exit;
    }
    ...
    public function oauth_callback() {
        ...
        wp_redirect( admin_url('admin.php?page=followup-emails-settings&tab=integration&message='. $message) );
        exit;
    ...
    public function twitter_contact_method( $user ) {
        ...
        <table class="form-table">
            <tr>
                <th scope="row"><?php _e( 'Twitter Handle' ); ?></th>
                <td>
    ...
    public function format_twitter_handle( $user_id ) {
        ...
        $handle = ltrim( $_POST['twitter_handle'], '@' );

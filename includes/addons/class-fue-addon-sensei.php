...
class FUE_Addon_Sensei {
    ...
    public function __construct() {
        ...
        add_action( 'fue_settings_saved', array($this, 'addon_save_settings') );
    }
    ...
    public function email_variables_list( $email ) {
        ...
        ?>
        <li class="var hideable var_sensei var_sensei_course"><strong>{teacher_first_name}</strong> <img class="help_tip" title="<?php _e('The Teacher\'s first name', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_sensei var_sensei_course"><strong>{teacher_last_name}</strong> <img class="help_tip" title="<?php _e('The Teacher\'s last name', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_sensei var_sensei_course"><strong>{teacher_name}</strong> <img class="help_tip" title="<?php _e('The Teacher\'s full name', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        ...
        <?php if ( self::is_certificates_installed() ): ?>
            ...
            <li class="var hideable var_sensei var_sensei_course"><strong>{certificate_link}</strong> <img class="help_tip" title="<?php _e('The link to the course certificate with the course name as the display text', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <?php endif; ?>

        <li class="var hideable var_sensei var_sensei_lesson"><strong>{lesson_name}</strong> <img class="help_tip" title="<?php _e('The name of the lesson', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_sensei var_sensei_lesson"><strong>{lesson_url}</strong> <img class="help_tip" title="<?php _e('The raw URL to the lesson', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_sensei var_sensei_lesson"><strong>{lesson_link}</strong> <img class="help_tip" title="<?php _e('The link to the lesson with the lesson name as the display text', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>

        <li class="var hideable var_sensei var_sensei_quiz"><strong>{quiz_url}</strong> <img class="help_tip" title="<?php _e('The raw URL to the quiz', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_sensei var_sensei_quiz"><strong>{quiz_link}</strong> <img class="help_tip" title="<?php _e('The link to the quiz', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_sensei var_sensei_quiz var_sensei_grade"><strong>{quiz_grade}</strong> <img class="help_tip" title="<?php _e('The score the user got on the quiz', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_sensei var_sensei_quiz var_sensei_passmark"><strong>{quiz_passmark}</strong> <img class="help_tip" title="<?php _e('The passing mark on the quiz taken', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL ; ?>/images/help.png" width="16" height="16" /></li>
        <?php
    }
    ...
    public function addon_save_settings() {
        ...
        if ( $post['section'] == 'integration' ) {
            ...
            $completed                  = (isset($_POST['sensei_course_completed_email'])) ? (int)$_POST['sensei_course_completed_email'] : 0;
            $completed_email_subject    = '';
            $completed_email_body       = '';

            $incomplete                 = (isset($_POST['sensei_course_incomplete_email'])) ? (int)$_POST['sensei_course_incomplete_email'] : 0;
            $incomplete_email_subject   = '';
            $incomplete_email_body      = '';
            $deadline_number    = absint( $_POST['sensei_course_incomplete_email_deadline_number'] );
            $deadline_period    = $_POST['sensei_course_incomplete_email_deadline_period'];

            if ( $completed ) {
                $completed_email_subject    = $_POST['sensei_course_completed_email_subject'];
                $completed_email_body       = $_POST['sensei_course_completed_email_body'];
            }

            if ( $incomplete ) {
                $incomplete_email_subject    = $_POST['sensei_course_incomplete_email_subject'];
                $incomplete_email_body       = $_POST['sensei_course_incomplete_email_body'];
            }

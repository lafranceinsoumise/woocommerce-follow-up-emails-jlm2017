...
class FUE_Addon_Wootickets {
    ...
    public function manual_types() {
        ?><option value="event_attendees"><?php _e('Event Attendees', 'follow_up_emails'); ?></option><?php
    }
    ...
    public function manual_type_actions() {
        ...
        <div class="send-type-event-attendees send-type-div">
            ...
            <select id="attendee_status" name="attendee_status">
                <option value="all"><?php _e('Send to all attendees', 'follow_up_emails'); ?></option>
                <option value="checked_in"><?php _e('Send to checked in attendees', 'follow_up_emails'); ?></option>
                <option value="not_checked_in"><?php _e('Send to attendees who have not yet checked in', 'follow_up_emails'); ?></option>
            </select>
        </div>
    <?php
    }
            ...
            if ( $items ) {
                foreach ( $items as $item ) {
                    ...
                    if ( $post['attendee_status'] == 'checked_in' && $item['check_in'] != 1 ) {
                        continue;
                    } elseif ( $_POST['attendee_status'] == 'not_checked_in' && $item['check_in'] == 1 ) {
                        continue;
                    }
                    ...
                    if ( isset( $_POST['meta']['wootickets_type'] ) ) {
                        switch ( $_POST['meta']['wootickets_type'] ) {
                            ...
                            case 'event_categories':
                                $data['category_id']    = $_POST['ticket_event_category_id'];
                                $data['product_id']     = 0;
                                break;
                        }
                    }
    ...
    public function add_variables( $email ) {
        ...
        ?>
            <li class="var hideable var_events_calendar var_event_name">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The name of the event', 'follow_up_emails'); ?>"
            ...
            <li class="var hideable var_events_calendar var_event_link">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The name of the event with a link to the event page', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16"
                    />
            ...
            <li class="var hideable var_events_calendar var_event_url">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The URL of the event', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_location">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The name and address of the venue', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_organizer">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The name of the event organizer', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_start_datetime">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The start date/time of the event', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_end_datetime">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The end date/time of the event', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_venue_phone">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The phone number of the event venue', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_gcal">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The URL to the Google Calendar linked to the even', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_ical">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The URL to the iCalendar linked to the event', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_ticket_sale_start">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The date/time that tickets go on sale', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
            <li class="var hideable var_events_calendar var_event_ticket_sale_end">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The date/time that ticket sales end', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16"
                    />
            ...
            <li class="var hideable var_events_calendar var_event_ticket_name">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The name of the ticket', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16"
                    />
            ...
            <li class="var hideable var_events_calendar var_event_ticket_image">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The image assigned to the ticket', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16"
                    />
            ...
            <li class="var hideable var_events_calendar var_event_ticket_description">
                ...
                <img
                    class="help_tip"
                    title="<?php _e('The description of the ticket', 'follow_up_emails'); ?>"
                    src="<?php echo $woocommerce->plugin_url(); ?>/assets/images/help.png"
                    width="16"
                    height="16" />
            </li>
        ...
        <div class="field tribe_limit_tr">
            <label for="meta_tribe_limit">
                ...
                printf(
                    ...
                    '<input type="text" name="meta[tribe_limit_days]" size="2" value="'. $days .'" placeholder="5" />'
                );
                ?>
            </label>
        </div>
    ...
    public function save_settings() {
        ...
        if ( $post['section'] == 'integration' ) {
            ...
            if ( isset($post['event_booking_notification_time_hour']) ) {
                ...
                $previously_scheduled = wc_next_scheduled_action(
    ...
    public function attendees_table_script() {
        ...
        <script type="text/html" id="list_template_top">
            <select name="fue_list" id="fue_list" class="fue_list" style="display: none;">
                <option value="-1"><?php _e('New List', 'follow_up_emails'); ?></option>
    ...
    public function process_bulk_action( $action ) {
        ...
        if ( $_POST['fue_list'] != -1 ) {
            $list = $_POST['fue_list'];
        } elseif ( $_POST['fue_list2'] != -1 ) {
            $list = $_POST['fue_list2'];
        }

        if ( $list == -1 ) {
            $list = stripslashes( $_POST['fue_list_name'] );
        }
        ...
        foreach ( (array) $_POST['attendee'] as $attendee ) {
            ...
            Follow_Up_Emails::instance()->newsletter->add_to_list( $email, $list );
            $exported++;
        }
    }
    ...
    protected function remove_notification_summary_emails() {
        ...
        wc_unschedule_action( 'fue_wootickets_digest_email', $params, 'fue' );
    }

    protected function reschedule_notification_summary_emails() {
        wc_unschedule_action( 'fue_wootickets_digest_email', array('wootickets_summary'), 'fue' );

...
class FUE_Addon_Subscriptions extends FUE_Addon_Woocommerce_Scheduler {
    ...
    public function update_notice() {
        ...
        if ( get_option( 'fue_subscription_needs_update' ) == 1 ) {
            ...
            <div id="message" class="updated">
                <p><?php _e( '<strong>Follow-Ups Data Update Required</strong>', 'follow_up_emails' ); ?></p>
                <p class="submit"><a href="<?php echo add_query_arg( 'tab', 'subscription_update', admin_url( 'admin.php?page=followup-emails' ) ); ?>" class="fue-update-now button-primary"><?php _e( 'Run the updater', 'follow_up_emails' ); ?></a></p>
            </div>
    ...
    public function admin_scripts() {
        if ( !empty( $_GET['tab'] ) && $_GET['tab'] == 'subscription_update' ) {
    ...
    public function register_email_type( $types ) {
        ...
        $triggers = array(
            ...
            'subs_payment_failed'   => __('after subscription payment failed', 'follow_up_emails'),
    ...
    public function email_variables_list( $email ) {
        ...
        if ( $email->product_id > 0 ): ?>
            <li class="var hideable var_subscriptions"><strong>{item_name}</strong> <img class="help_tip" title="<?php _e('The subscription product\'s name', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
            ...
            <li class="var hideable var_subscriptions"><strong>{item_categories}</strong> <img class="help_tip" title="<?php _e('The list of categories where the purchased items are under.', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
        <?php else: ?>
            <li class="var hideable var_subscriptions"><strong>{item_names}</strong> <img class="help_tip" title="<?php _e('Displays a list of purchased items.', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
            <li class="var hideable var_subscriptions"><strong>{item_names_list}</strong> <img class="help_tip" title="<?php _e('Displays a comma-separated list of purchased items.', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
            <li class="var hideable var_subscriptions"><strong>{item_categories}</strong> <img class="help_tip" title="<?php _e('The list of categories where the purchased items are under.', 'follow_up_emails'); ?>" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" width="16" height="16" /></li>
        <?php endif; ?>
        <li class="var hideable var_subscriptions"><strong>{subs_renew_date}</strong> <img class="help_tip" title="<?php _e('The date that a customer\'s subscription renews', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_subscriptions"><strong>{subs_end_date}</strong> <img class="help_tip" title="<?php _e('The date that a customer\'s subscription ends', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_subscriptions"><strong>{days_to_renew}</strong> <img class="help_tip" title="<?php _e('The number of days before a subscription is up for renewal', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_subscriptions"><strong>{subs_start_date}</strong> <img class="help_tip" title="<?php _e('The start date of the subscription', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_subscriptions"><strong>{subs_trial_length}</strong> <img class="help_tip" title="<?php _e('The length of the trial (e.g. 20 days)', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_subscriptions"><strong>{subs_first_payment}</strong> <img class="help_tip" title="<?php _e('The initial cost + any signup fees', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_subscriptions"><strong>{subs_cost_term}</strong> <img class="help_tip" title="<?php _e('The cost and term of the subscription', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_subscriptions"><strong>{subs_cost}</strong> <img class="help_tip" title="<?php _e('The cost of the subscription', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <li class="var hideable var_subscriptions"><strong>{subs_id}</strong> <img class="help_tip" title="<?php _e('The ID of the subscription', 'follow_up_emails'); ?>" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></li>
        <?php
    }
    ...
    public function modify_insert_send_date( $insert, $email ) {
        ...
        if ( self::is_wcs_2() ) {
            ...
            $subs_key = self::get_subscription_key( $order_id );

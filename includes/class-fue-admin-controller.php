...
class FUE_Admin_Controller {
    ...
    public static function get_screen_ids() {
        return apply_filters('fue_screen_ids', array(
            ...
            'follow-up-emails_page_followup-emails-reports-customers',
            ...
            'follow-up-emails_page_followup-emails-templates'
        ));
    }
    ...
    public static function replace_email_form_url($url, $original_url, $_context) {
        ...
        } elseif ( $url == 'admin.php?page=fue_post_tweet' ) {
    ...
    public static function subscribers_table() {
        $wpdb   = Follow_Up_Emails::instance()->wpdb;
        $view   = ( empty($_REQUEST['view']) ) ? 'subscribers' : $_REQUEST['view'];
    ...
    /**
     * Handler for db version 20160203 that removes unnecessary scheduled-action rows
     */
    ...
    public static function settings_scripts() {
        ...
        $fue_pages = array(
            'followup-emails', 'followup-emails-form', 'followup-emails-reports', 'followup-emails-reports-customers', 'followup-emails-queue', 'followup-emails-subscribers'
        );

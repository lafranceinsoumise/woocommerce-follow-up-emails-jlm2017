...
if ( !class_exists( 'FUE_DNS_Query' ) ):
    class FUE_DNS_Query
    {
        ...
        function __construct($server,$port=53,$timeout=60,$udp=true,$debug=false)
        {
            $this->server=$server;
            $this->port=$port;

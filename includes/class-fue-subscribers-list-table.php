    ...
    public function display() {
        ...
        <form method="get" id="subscribers_list_form">
            ...
            <div id="div_lists" style="display:none;">
                <select name="list[]" id="select_lists" class="select2" multiple style="width: 300px; clear: both;" data-placeholder="<?php _e('Select lists', 'follow_up_emails'); ?>">
                    <option></option>
                    <?php foreach ( $this->newsletter->get_lists() as $list ): ?>
